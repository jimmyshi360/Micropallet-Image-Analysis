 ...
 * green, and blue values of the pixel at the cursor when ursor.  It also lets you zoom in or
...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener {
	 ...
	 */
	public PictureExplorer(DigitalPicture picture, JPanel imageViewPanel) {
		// set the fields
	...
	private void createAndInitPictureFrame() {
		...
		imageViewPanel.setFocusTraversalPolicy(newPolicy);
	...
	private void setUpMenuBar() {
		...
		//imageViewPanel.setJMenuBar(menuBar);
	}
	...
	private void createAndInitScrollingImage() {
		...
		imageViewPanel.add(scrollPane, BorderLayout.CENTER);
	}
	...
	private void createInfoPanel() {
		...
		// add the info panel
		imageViewPanel.add(BorderLayout.NORTH, infoPanel);
	}
